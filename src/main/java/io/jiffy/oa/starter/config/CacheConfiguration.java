package io.jiffy.oa.starter.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("starter");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("starter");
        ...
        config.getMapConfigs().put("io.jiffy.oa.starter.domain.*", initializeDomainMapConfig(jHipsterProperties));
